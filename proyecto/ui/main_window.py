# proyecto/ui/main_window.py - CÓDIGO MODIFICADO (botones movidos a sidebar)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Panel izquierdo (barra lateral) - MODIFICADO PARA INCLUIR BOTONES
        ...
        # Espacio para categorías web (sin los botones que se eliminaron)
        ...
        # Barra de búsqueda - SIMPLIFICADA (sin botones)
        search_bar = QWidget()
        search_bar.setObjectName("search-bar")
        search_bar.setFixedHeight(70)
        search_layout = QHBoxLayout(search_bar)
        
        # Solo un espacio en blanco - barra limpia
        ...
        # *** BOTONES MOVIDOS AL PANEL DERECHO ***
        # Sección de herramientas
        tools_label = QLabel("🛠️ Herramientas")
        tools_label.setStyleSheet("font-weight: bold; color: #a0a0a0; font-size: 12px; padding: 8px 0;")
        db_categories_layout.addWidget(tools_label)
        
        # Botón StreamWish movido aquí
        try:
            from opciones.opcion1.config_streamwish import StreamWishConfig
            STREAMWISH_AVAILABLE = True
            self.streamwish_btn = QPushButton("🔌 Conectar a StreamWish")
            ...
            db_categories_layout.addWidget(self.streamwish_btn)
        except ImportError:
            STREAMWISH_AVAILABLE = False
        
        # Botón Programar movido aquí
        if SCHEDULER_UI_AVAILABLE:
            self.scheduler_quick_btn = QPushButton("📅 Programar Tareas")
            self.scheduler_quick_btn.setStyleSheet("""
                QPushButton {
            ...
            db_categories_layout.addWidget(self.scheduler_quick_btn)
        ...
        db_categories_layout.addWidget(separator)
        
        # *** FIN DE BOTONES MOVIDOS ***
    ...
    # (Mantengo solo las funciones principales, el resto no cambió)
